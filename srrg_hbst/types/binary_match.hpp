...
class BinaryMatch {
 public:
  ...
  std::vector<const Matchable*>
      matchable_references;  // ds multiple references are possible for
                             // identical matching distance
  ObjectType object_query;
  std::vector<ObjectType>
      object_references;  // ds multiple references are possible for identical
                          // matching distance
  real_type distance;
};
}  // namespace srrg_hbst
