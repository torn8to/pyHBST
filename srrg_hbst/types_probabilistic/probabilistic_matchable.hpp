...
class ProbabilisticMatchable
    : public BinaryMatchable<ObjectType_, descriptor_size_bits_> {
 ...
 public:
  ...
  typedef
      typename BinaryMatchable<ObjectType_, descriptor_size_bits_>::Descriptor
          Descriptor;
  typedef Eigen::Matrix<real_precision_, descriptor_size_bits_, 1>
      BitStatisticsVector;
 ...
 public:
  ProbabilisticMatchable(ObjectType object_,
      ...
      : BinaryMatchable<ObjectType_, descriptor_size_bits_>(
            object_, descriptor_, image_identifier_),
 ...
 public:
  ...
  // ds statistical data: bit volatity info, maximum number of appearances where
  // the bit was stable - currently not used
